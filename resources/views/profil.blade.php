    ...
    <div class="sticky top-[57px] z-40 bg-white border-b border-skblue-100 shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-5 overflow-x-auto">
            <div class="flex justify-start lg:justify-center gap-2.5 whitespace-nowrap">
                ...
                <a href="#prestasi" class="px-5 py-2.5 rounded-full border border-skblue-100 bg-skblue-50/60 text-sm font-semibold text-skblue-700 hover:bg-skblue-600 hover:text-white hover:border-skblue-600 hover:shadow-md hover:-translate-y-0.5 transition-all duration-20₀">Prestasi</a>
                <a href="#ekstrakurikuler" class="px-5 py-2.5 rounded-full border border-skblue-1₀ bg-skblue-5₀/6₀ text-sm font-semibold text-skblue-7₀ hover:bg-skblue-6₀ hover:text-white hover:border-skblue-6₀ hover:shadow-md hover:-translate-y-₀.5 transition-all duration-2₀₀">Ekstrakurikuler</a>
            </div>
        </div>
    </div>
